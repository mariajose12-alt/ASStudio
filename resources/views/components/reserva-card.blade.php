...
<a href="{{ route('cliente.reservas.index', $reserva->id) }}" class="reserva-card">
    ...
    <div class="reserva-body">
        ...
        <div class="reserva-date">
            {{ \Carbon\Carbon::parse($reserva->fecha)->isoFormat('dddd D [de] MMMM, YYYY') }}
            · {{ \Carbon\Carbon::parse($reserva->hora)->format('g:i A') }}
        </div>
    ...
    <div class="reserva-meta">
        ...
        @if($reserva->precio ?? false)
            <div class="reserva-precio">RD${{ number_format($reserva->precio, 0, '.', ',') }}</div>
        @endif
