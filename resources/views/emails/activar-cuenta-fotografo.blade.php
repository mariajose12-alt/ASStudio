...
@section('email_title', 'Activa tu cuenta')
...
@section('content')
    ...
    <p style="margin:0 0 24px;font-family:Arial,sans-serif;font-size:15px;color:#4a4a4a;line-height:1.7;">
        Se creó una cuenta para ti con el correo
        <strong style="color:#1a0d00;">{{ $usuario->email }}</strong>.
        Para terminar de activarla, configura tu propia contraseña haciendo clic en el botón de abajo.
    </p>
    ...
    <p style="margin:0;font-family:Arial,sans-serif;font-size:13px;color:#9ca3af;line-height:1.6;">
        Este enlace expira en 48 horas. Si no esperabas este correo, puedes ignorarlo.
    </p>
