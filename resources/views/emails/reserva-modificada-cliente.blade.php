...
@section('email_title', 'Propuesta de Modificación')
...
@section('content')
    ...
    <h1 style="margin:0 0 12px;font-family:Georgia,'Times New Roman',serif;font-size:26px;font-weight:700;color:#1a0d00;line-height:1.3;text-align:center;">
        El fotógrafo propone un cambio
    </h1>
    ...
    <p style="margin:0 0 32px;font-family:Arial,sans-serif;font-size:15px;line-height:1.7;color:#4b5563;text-align:center;">
        ...
        tu fotógrafo ha propuesto una modificación a tu reserva.
    </p>
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"
        ...
        <tr>
            <td style="padding:14px 20px;background-color:#ffffff;">
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        <td width="140" valign="top" style="padding-right:12px;">
                            <span style="font-family:Arial,sans-serif;font-size:11px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:#9ca3af;">Propuesta</span>
                        </td>
                        <td valign="top">
                            <span style="font-family:Arial,sans-serif;font-size:14px;color:#1a0d00;font-weight:500;line-height:1.6;">{{ $reserva->motivo_rechazo }}</span>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td style="background-color:#fff3e8;border-left:4px solid #e87722;padding:14px 18px;border-radius:0 8px 8px 0;">
                <p style="margin:0;font-family:Arial,sans-serif;font-size:14px;color:#1a0d00;line-height:1.6;">
                    <strong>Tu decisión importa:</strong> Ingresa a la plataforma para aceptar o rechazar esta propuesta de modificación.
                </p>
            </td>
        </tr>
    </table>
