...
@section('email_title', 'Solicitud de Ayudante')
...
@section('content')
    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
        <tr>
            <td align="center" style="padding-bottom:24px;">
                <div style="display:inline-block;width:56px;height:56px;border-radius:50%;background-color:#eef2ff;border:2px solid rgba(79,70,229,0.3);text-align:center;line-height:56px;font-size:24px;">
                    👥
                </div>
            </td>
        </tr>
    ...
    <p style="margin:0 0 32px;font-family:Arial,sans-serif;font-size:15px;line-height:1.7;color:#4b5563;text-align:center;">
        <strong style="color:#1a0d00;">{{ $solicitud->solicitante->getPersona()->nombre }} {{ $solicitud->solicitante->getPersona()->apellido }}</strong>
        necesita <strong style="color:#1a0d00;">{{ $solicitud->cantidad_ayudantes }}</strong> ayudante(s) para una sesión. Si estás disponible, puedes postularte.
    </p>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        <td width="140" valign="top">
                            <span style="font-family:Arial,sans-serif;font-size:11px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:#9ca3af;">Tipo de sesión</span>
                        </td>
                        <td valign="top">
                            <span style="font-family:Arial,sans-serif;font-size:14px;color:#1a0d00;font-weight:600;">{{ $solicitud->sesion->reserva->tipo }}</span>
                        </td>
                    </tr>
                </table>
            </td>
            ...
            <td style="padding:14px 20px;background-color:#ffffff;border-bottom:1px solid #e8e8e8;">
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        ...
                        <td valign="top">
                            <span style="font-family:Arial,sans-serif;font-size:14px;color:#1a0d00;font-weight:500;">{{ $solicitud->sesion->lugar ?? 'Estudio' }}</span>
                        </td>
                    </tr>
                </table>
            </td>
            ...
            <td style="padding:14px 20px;background-color:#fafafa;border-bottom:1px solid #e8e8e8;">
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        ...
                        <td valign="top">
                            <span style="font-family:Arial,sans-serif;font-size:14px;color:#1a0d00;font-weight:500;">{{ \Carbon\Carbon::parse($solicitud->sesion->fecha_inicio)->format('d/m/Y') }}</span>
                        </td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td style="padding:14px 20px;background-color:#ffffff;">
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                    <tr>
                        <td width="140" valign="top">
                            <span style="font-family:Arial,sans-serif;font-size:11px;font-weight:700;letter-spacing:1px;text-transform:uppercase;color:#9ca3af;">Hora</span>
                        </td>
                        <td valign="top">
                            <span style="font-family:Arial,sans-serif;font-size:14px;color:#1a0d00;font-weight:500;">{{ \Carbon\Carbon::parse($solicitud->sesion->fecha_inicio)->format('H:i') }} hrs</span>
                        </td>
                    </tr>
                </table>
            </td>
            ...
            <tr>
                <td style="background-color:#fff3e8;border-left:4px solid #e87722;padding:14px 18px;border-radius:0 8px 8px 0;">
                    <p style="margin:0;font-family:Arial,sans-serif;font-size:14px;color:#1a0d00;line-height:1.6;">
                        <strong>Nota:</strong> {{ $solicitud->mensaje }}
                    </p>
                </td>
            </tr>
        </table>
