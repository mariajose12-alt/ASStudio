...
<aside class="sidebar">
    ...
    <div class="user-card" style="margin: 16px;">
        ...
        <div class="user-avatar">
            {{ strtoupper(substr(Auth::user()->persona->nombre ?? 'C', 0, 1)) }}
        </div>
        --}}
        <div class="user-name">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('cliente.perfil') }}" class="nav-link {{ request()->routeIs('cliente.perfil*') ? 'active' : '' }}">
        ...
        {{--
        <a href="{{ route('cliente.ajustes') }}" class="nav-link {{ request()->routeIs('cliente.ajustes*') ? 'active' : '' }}">
