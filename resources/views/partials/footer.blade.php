    ...
    <div class="footer-inner">
        ...
        <div class="footer-col footer-col-brand">
            ...
            <div class="footer-socials">
                ...
                <a href="https://www.tiktok.com/@abrahamsanchezgi" target="_blank" rel="noopener" class="footer-social-link" aria-label="TikTok">
                ...
                <a href="https://api.whatsapp.com/message/KKXI6NZQCFZYB1?autoload=1&app_absent=0" target="_blank" rel="noopener" class="footer-social-link" aria-label="WhatsApp">
        ...
        <div class="footer-col">
            ...
            <ul class="footer-info">
                ...
                <li>
                    ...
                    <span>astudiophotographyy@gmail.com</span>
                </li>
                <li>
