...
<div class="es-modal-overlay" id="modalReglas">
    <div class="es-modal-content es-modal-reglas">
        <button type="button" class="es-modal-close" onclick="cerrarModalReglas()" aria-label="Cerrar">
            &times;
        </button>
        ...
        <div class="es-rules-grid es-rules-grid-modal">
        ...
        <div class="es-modal-footer">
            <label class="es-checkbox-label">
                <input type="checkbox" id="aceptaReglas" onchange="toggleBotonConfirmar(this)">
                He leído y acepto las reglas del estudio
            </label>
            <button type="button" class="btn-primary" onclick="cerrarModalReglas()">Entendido</button>
        </div>
    </div>
</div>
